window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const VERDICT_CLASSES = {
			"ok": {
				dot: `${AdvisorCard_module_css_default.dot} ${AdvisorCard_module_css_default.dotOk}`,
				title: `${AdvisorCard_module_css_default.title} ${AdvisorCard_module_css_default.titleOk}`
			},
			"off-track": {
				dot: `${AdvisorCard_module_css_default.dot} ${AdvisorCard_module_css_default.dotOffTrack}`,
				title: `${AdvisorCard_module_css_default.title} ${AdvisorCard_module_css_default.titleOffTrack}`
			}
		};
		function verdictClasses(verdict) {
			return VERDICT_CLASSES[verdict] ?? {
				dot: `${AdvisorCard_module_css_default.dot} ${AdvisorCard_module_css_default.dotNeedsAttention}`,
				title: `${AdvisorCard_module_css_default.title} ${AdvisorCard_module_css_default.titleNeedsAttention}`
			};
		}
		/**
		...
		*/
		...
		const advisorDefinition = {
			...
			target: "chat",
			match: (event) => {
				const data = parseAdvisorData(event);
			...
			start: (_context, match) => {
				const data = parseAdvisorData(match.event);
